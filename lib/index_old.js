...
//d
var cropImage = function cropImage(params) {
  this.zIndex = 100;
  this.waitbegin = '...';
  ...
  this.crop = function (file, elem, cropping) {
    ...
    if (file.type.match('image.*')) {
      ...
      if (!((typeof cropping === 'undefined' ? 'undefined' : _typeof(cropping)) === 'object' && cropping.height != null && cropping.width != null && cropping.max != null && cropping.circle != null)) {}
